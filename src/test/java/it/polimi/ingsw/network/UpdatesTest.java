...
public class UpdatesTest {
    ...
    public void TestReconnect(){
        ...
        //--------------------------------------------
        ReconnectUpdate ru=new ReconnectUpdate(faithPaths,popefavors,null,strongboxes,warehouses,marbles,cardMatrix,playerOrder,currentNickname,slots,allLeadersInBoard,myLeadersInHand,GamePhase.ONGOING,new ArrayList<>(),new ArrayList<>());
        ru.update(cmnew);
