...
public class PassCommand implements Command {
    @Override
    public void doAction(Controller c, String nickname) throws IllegalCommandException, IllegalActionException, NotYourTurnException, WaitingReconnectionsException {
